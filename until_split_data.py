...
files_train= glob.glob("dataset/Synthetic_v3_InstanceSegmentation/train_seg_50x25/**.pth")
...
os.makedirs('dataset/Synthetic_v3_InstanceSegmentation/train_seg_50x25/train/',exist_ok=True)
os.makedirs('dataset/Synthetic_v3_InstanceSegmentation/train_seg_50x25/val/',exist_ok=True)
