...
class Dataset:
    ...
    def trainLoader(self):
        if self.train_split == 'trainval':
            train_file_names = sorted(glob.glob(os.path.join(self.data_root, self.dataset, cfg.train_dataset, '*' + self.filename_suffix))
                + glob.glob(os.path.join(self.data_root, self.dataset, cfg.val_dataset, '*' + self.filename_suffix))
            )
    ...
    def valLoader(self):
        val_file_names = sorted(glob.glob(os.path.join(self.data_root, self.dataset, cfg.val_dataset, '*' + self.filename_suffix)))
    ...
    def testLoader(self):
        self.test_file_names = sorted(glob.glob(os.path.join(self.data_root, self.dataset, cfg.test_dataset, '*' + self.filename_suffix)))
